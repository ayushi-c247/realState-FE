...
> = ({ password }) => {
  const tFront = useTranslations("Front");
    ...
    <Box mb="lg">
      ...
      <Box component="ul" pl="md" mb="sm" mt={2}>
        ...
        <Text
          ...
          fz={12}
          fw={400}
          c={hasUpper && hasLower ? "green" : "#64748B"}
        >
